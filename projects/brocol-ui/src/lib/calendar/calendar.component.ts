...
@Component({
  ...
  imports: [JsonPipe, UiCalendarMonthComponent, ReactiveFormsModule, NgFor],
...
export class UiCalendarComponent extends ActiveDateDirective implements OnInit  {
  ...
  private updateActiveDateOnMonthChange() { // convertir this.months por activeMonths en directiva (activeMonth actual pasaría a ser un private _firstMonth)
